...
const about = {
  en: {
    title: "The Scope, edited by Ditto",
    intro:
  ...
  fr: {
    ...
    publisherBefore: "The Scope est édité et publié par l'équipe de ",
    publisherAfter:
...
export function createAboutRoute(locale: MediaLocale) {
  ...
  const dittoHome = `${SITE_URL}/${locale}`;
      ...
      <MediaShell locale={locale} mirrorPath="/about">
        ...
        <div className="ns-wrap">
          ...
          <div className="ns-about-body">
            <p>{page.method}</p>
            <p>
              {page.publisherBefore}
              <a href={dittoHome}>Ditto</a>
              {page.publisherAfter}
            </p>
            <p>
