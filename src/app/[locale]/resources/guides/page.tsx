    ...
    <div className="page-wrapper">
      <main className="main-wrapper">
        ...
        <div className={DEVLINK_SCOPE_CLASS} style={{ display: "contents" }}>
            ...
            <div className="padding-global">
              ...
              <div className="container-84rem">
                <div className="breadcrumbs_list">
                  ...
                  <a href={`${prefix}/resources/guides`} className="link-size-1rem">{t("resourcesPage.guides")}</a>
                </div>
              </div>
              <div className="spacer-1x5rem"></div>
            </div>
            ...
            <div className="padding-global">
              ...
              <div className="container-55rem">
                <div className="header">
                  <h1 className="heading-size-4rem">{t("resourcesGuides.heading")}</h1>
                </div>
                ...
                <div className="blogui_block">
                  <div className="blogui_list">
                    ...
                    <a href={`${prefix}/resources/guides`} className="blogui_link w--current">{t("resourcesPage.guide")}</a>
                  </div>
                </div>
              </div>
              <div data-wf--padding--space="small-3rem" className="spacer-component"></div>
          ...
          {/* Guide list (Collection List - CMS content will come later) */}
