...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: locale === "fr" ? "https://www.trustditto.com/fr/legal/mentions-legales" : "https://www.trustditto.com/en/legal/legal-notices",
      languages: {
        "x-default": "https://www.trustditto.com/en/legal/legal-notices",
        en: "https://www.trustditto.com/en/legal/legal-notices",
        fr: "https://www.trustditto.com/fr/legal/mentions-legales",
      },
    },
    openGraph: {
      title: t("legalNotices.title"),
...
export default async function LegalNoticesPage({ params }: { params: Promise<{ locale: string }> }) {
  const { locale } = await params;
            ...
            <div className="padding-global">
              ...
              <div className="container-84rem">
                <div className="breadcrumbs_list">
                  <a href={`${prefix}/legal/legal-notices`} className="link-size-1rem">{t("legalNotices.breadcrumbParent")}</a>
                  ...
                  <a href={`${prefix}/legal/legal-notices`} className="link-size-1rem">{t("legalNotices.breadcrumb")}</a>
                </div>
              </div>
              <div className="spacer-1x5rem"></div>
            </div>
              ...
              <div className="container-84rem">
                <div className="post-hero_component">
                  <div className="post-hero_content">
                    <h1 className="heading-size-3rem">{t("legalNotices.title")}</h1>
                    <div className="spacer-1x5rem"></div>
                    <p className="text-size-1x375rem">{t("legalNotices.effectiveDate")}</p>
                  </div>
                </div>
              </div>
