...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        "x-default": "https://www.trustditto.com/en/legal/terms-and-conditions",
    ...
    <div className="page-wrapper">
      <main className="main-wrapper">
        ...
        <div className={DEVLINK_SCOPE_CLASS} style={{ display: "contents" }}>
            ...
            <div className="padding-global">
              ...
              <div className="container-80rem">
                <div className="breadcrumbs_list">
                  <a href={`${prefix}/legal/terms-and-conditions`} className="link-size-1rem">{t("legalTerms.breadcrumbParent")}</a>
                  ...
                  <a href={`${prefix}/legal/terms-and-conditions`} className="link-size-1rem">{t("legalTerms.breadcrumb")}</a>
                </div>
              </div>
              <div className="spacer-1x5rem"></div>
            </div>
              ...
              <div className="container-80rem">
                <div className="post-hero_component">
                  <div className="post-hero_content">
                    <h1 className="heading-size-3rem">{t("legalTerms.title")}</h1>
                    <div className="spacer-1x5rem"></div>
                    <p className="text-size-1x375rem">{t("legalTerms.effectiveDate")}</p>
                  </div>
                </div>
              </div>
          ...
          {/* Post Content - Rich text rendered inline */}
                    ...
                    <div className="post_content">
                      <div id="company" className="post_chapter">
                        <div
                          ...
                          dangerouslySetInnerHTML={{ __html: LEGAL_CONTENT["terms-and-conditions"] }}
                        />
                      </div>
                    </div>
                  </div>
