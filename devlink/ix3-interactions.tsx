...
async function loadAndCreateIX3Engine(): Promise<IX3Engine> {
  ...
  // engine/src/modules/devlink-ix3.d.ts (the real source lives in
  ...
  await import("./modules/devlink-gsap");
  const { createIX3Engine } = await import("./modules/devlink-ix3");
...
export const IX3Provider: React.FC<{ children: React.ReactNode }> = ({
  ...
  // dynamically import `./modules/devlink-{ix3,gsap}` on every page
